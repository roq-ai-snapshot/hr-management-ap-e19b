  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to HR Management Application - Streamlining your human resources tasks, improving efficiency, and enhancing productivity, all in one place."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HR Management Application - Streamlining your human resources tasks, improving efficiency, and enhancing productivity, all in one place.`}
            </Text>
            <Box
