  ...
  const columns: ColumnType[] = [
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.registration_date ? format(record?.registration_date, 'dd-MM-yyyy') : '',
    },
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.last_purchase_date ? format(record?.last_purchase_date, 'dd-MM-yyyy') : '',
    },
    { id: 'total_purchases', header: 'total_purchases', accessorKey: 'total_purchases' },
    { id: 'total_spent', header: 'total_spent', accessorKey: 'total_spent' },
